    ...
    var j = {
        ...
        preFilter: {
            ...
            PSEUDO: function(a, b, c, e, f) {
                ...
                if (j.match.POS.test(a[0]) || j.match.CHILD.test(a[0])) return !0;
                return a
            },
            POS: function(a) {
                a.unshift(!0);
...
STK.register("core.dom.builder", function(a) {
    return function(b, c) {
        ...
        f = {};
        if (c)
            for (j in selectorList) f[j] = a.core.dom.sizzle(c[j].toString(), e);
        else {
...
STK.register("core.json.include", function(a) {
    return function(a, b) {
        ...
        if (typeof b[c] == "number" || typeof b[c] == "string") {
            if (b[c] !== a[c]) return !1
...
var FM = function(a, b, c) {
    ...
    function cH(a) {
        ...
        for (var c in a)
            if (U(a[c]) === "array")
                for (var d = 0, e = a[c].length; d < e; ++d) b.push(c + "=" + a[c][d]);
            else b.push(c + "=" + a[c]);
        return b.join("&")
    }
    ...
    function cF(a, b) {
        ...
        if (!cr(cm, a))
            if (cj) {
                ...
                cz(a)
            } else cl ? b ? k.replace(cq(k.toString()) + "#!" + a) : k.hash = "#!" + a : cv(a, b);
            else cz(a)
    }
    ...
    function cC() {
        if (cj) {
            ...
            br(b, "popstate", cA)
        } else ck ? br(b, "hashchange", cB) : cl ? cy = setInterval(cB, 200) : cw(cm, function(a) {
            k.hash = "#!" + a;
            cz(a)
        })
    }
    ...
    function bC(a) {
        ...
        if (/complete/.test(g.readyState)) a();
        else {
            if (n) br(g, "DOMContentLoaded", c);
            else {
    ...
    function bw(a) {
        ...
        if (bs) {
            ...
            bs.setItem(bu, b)
        } else b === 0 && (g.documentElement.scrollTop = g.body.scrollTop = 1)
    }
    ...
    function bv() {
        ...
        if (bs) {
            a = bs.getItem(bt);
            b = bs.getItem(bu);
            if (a === k.toString() && b !== c) return parseInt(b, 0)
        }
        return !1
    }
    ...
    function bd(a, b) {
        ...
        (function d() {
            var a = t();
            while (c.length > 0 && t() - a < 50) b && b(c.shift());
            c.length > 0 && j(d, 25)
        })()
    }
    ...
    function _(a) {
        ...
        return {
            createServer: function(a) {
                if (U(a) !== "function") throw "connent.createServer: fn is not a function!";
                b || G(d, b = a)
            },
            request: $,
            destroy: function() {
    ...
    var bE = "allViewReady",
        ...
        bN = 0,
        bO = 0,
        bP, bQ, bR, bS, bT, bU, bV = "fromStateChange";
    G(bg, function(a, b) {
        bV = b;
        l(bT);
        bL = !0;
    ...
    var b$, b_ = "ajaxpagelet=1&ajaxpagelet_v6=1",
        ca = "__ref",
        cb, cd = n ? function(a, b, c) {
    ...
    var ci = b.history,
        cj = !! ci.pushState,
        ck = cj || "onhashchange" in b && (U(g.documentMode) === "undefined" || g.documentMode == 8),
        cl = ck || o && o > 7,
        cm, cs = "_stateChange",
        ct, cu = z(),
        cy;
    ...
    (function() {
        ...
        a[cY] = c;
        if (f)
            for (e = f.length; d < e; ++d) I.apply(b, f[d])
    })();
    return a
}(FM, window);
! function(a) {
    ...
    function g() {
        var a = document.body,
            b = "FRAME_" + c.bpType.split("_")[0],
            d = a.className,
            e = !d ? [] : d.split(/\s+/);
        if (f[b] !== undefined) {
            var g = [b].concat(f[b] || []);
            while (d = e.shift()) /^(FRAME_|S_|B_)/.test(d) || g.push(d);
            g = g.join(" ");
...
(function(a) {
            ...
            O = c("/Class_base").extend({
                ...
                show: function(a) {
                    ...
                    if ( !! b) {
                        ...
                        } else this.trigger("shown"); if (b.heightWithAni) {
    ...
    "/mask": function(a, b, c, d) {
        ...
        var e = c("/$")[0],
            ...
            k, l = !1,
            m = "STK-Mask-Key",
            n = e.core.dom.setStyle,
            o = e.core.dom.getStyle,
            p = e.core.evt.custEvent,
            s = {
                getNode: function() {
                    return i
                },
...
function(a) {
    ...
    if ( !! b) {
        ...
        var d = {}, e, f, g, h, i = 750,
            ...
            k = 1e3,
            l = 30,
            m = ["swipe", "swipeLeft", "swipeRight", "swipeUp", "swipeDown", "tap", "doubleTap", "singleTap", "longTap", "drag"],
            n = {}, o, p;
...
function(a) {
    ...
    if (b) {
        ...
        c.setAttribute("href", "http://img.t.sinajs.cn/t6/style/css/patch/content/RWD_ipad.css?version=" + $CONFIG.version);
...
(function(a) {
    (function(b, c) {
        ...
        function s() {
            l.register(function() {
                e && (f = parseInt(h.height - a.core.dom.getSize(e).height - a.position(e).t + 10))
            });
            var b = a.sizzle('[fixed-item="true"]');
            for (var c in b) m(b[c]);
            var d = a.sizzle('[fixed-box="true"]');
            for (var c in d) p(d[c]);
            var e = a.E("plc_main");
            a.addEvent(window, "resize", r)
        }
        ...
        function p(b) {
            function c(a) {
                ...
                for (var c in a)
                    if (b !== a[c].parentNode) return !1;
                return b
            }
            if (b.getAttribute("hasfixed") !== "true") {
                b.setAttribute("hasfixed", "true");
                var d = a.sizzle('[fixed-inbox="true"]', b),
                    i = c(d);
                if (!i) return;
                var j = k.getSize(b),
                    m = [];
                for (var n in d) {
                    var o = k.cloneBox(d[n]);
                    m.push(o);
                    o.style.display = "none";
                    i.insertBefore(o, d[n])
                }
                var p = k.cloneBox(i);
                k.initChannel(b);
                ...
                var q = a.position(b);
                h = a.core.dom.getSize(document.body);
                var r = a.queryToJson(b.getAttribute("fixed-data") || "") || {}, s = e + parseInt(r.top || 0),
                    t = !1,
                    u = !1,
                    v = !1,
                    w = !1,
                    x = !1,
                    y, z = Math.ceil(q.l - h.width / 2),
                    A, B = d.length - 1;
                l.register(function(c) {
                    A = k.getSize(p);
                    var l = k.inFixedOrNoDisplay(b);
                    if (!l && q.t + j.height < c.top + e + 50) {
                        var n = a.core.dom.getSize(i),
                            o = h.height - c.top - f;
                        if (w && o < A.height + (e + parseInt(r.top || 0) || 0)) {
                        ...
                        if (w && v) {
                            ...
                            p.style.width = n.width + "px";
                            p.style.zIndex = g;
                            p.style.top = (e + parseInt(r.top || 0) || 0) + "px";
                            v = !1
                        }
                        ...
                        a.winSize().height - e < A.height && B > 0 && function() {
                            if (B > 0) {
                                d[B].parentNode != i && i.insertBefore(d[B], m[B]);
                                B--;
                                A = k.getSize(p);
                                a.winSize().height - e < A.height && B > 0 && arguments.callee()
                            }
                        }();
                        o < A.height + parseInt(s || 0) ? s = o - A.height : s = e + parseInt(r.top || 0);
                        p.style.position = "fixed";
                        ...
                        p.style.width = n.width + "px";
                        p.style.zIndex = g;
                        y = a.core.ani.tween(p, {
                            end: function() {
                                u = !0;
                                k.fireChannel(b, "fixed", {
                                    "fixed-target": p
                                });
                            ...
                            duration: Math.floor(200 * A.height / 300),
                            animationType: "linear"
                        }).play({
                            top: parseInt(s || 0)
                        }, {
                        ...
                        if (x || !w) return;
                        for (var t in d) i.insertBefore(d[t], m[t]);
                        k.removeFixStyle(p);
                        k.fireChannel(b, "removefixed", {
                            "fixed-target": p
                        });
                        B = d.length - 1;
                        w = !1;
        ...
        function o(b) {
            var c = a.sizzle('[fixed-inbox="true"]', b),
                d = e,
                f = c.length,
                g = 0;
            for (var h = f - 1; h >= 0; h--) {
        ...
        function n(b, c) {
            var d = a.position(c),
                i = a.position(b),
                j = a.queryToJson(b.getAttribute("fixed-data") || "") || {}, m = parseInt(b.getAttribute("fixed-bottomspace") || 0),
                n = !1,
                o = !1;
            ...
            l.register(function(i) {
                var l = k.getSize(c),
                    p = k.getSize(b),
                    q = k.inFixedOrNoDisplay(b);
                if (!q && d.t + l.height <= i.top) {
                    var r = h.height - i.top - f - m;
        ...
        function m(b) {
            if (b.getAttribute("hasfixed") !== "true") {
                b.setAttribute("hasfixed", "true");
                var c = a.position(b),
                    d = a.queryToJson(b.getAttribute("fixed-data") || "") || {}, i = !1,
                    j = !1;
                h = a.core.dom.getSize(document.body);
                var m = Math.ceil(c.l - h.width / 2),
                    n;
                k.initChannel(b);
                var o;
                l.register(function(l) {
                    var n = k.getSize(b);
                    if (c.t - parseInt(d.top || e) < l.top) {
                        var p = h.height - l.top - f;
                        if (i && p < n.height + parseInt(d.top || e)) {
                        ...
                        if (j) {
                            b.style.position = "fixed";
                            b.style.top = parseInt(d.top || e) + "px";
                            b.style.left = "50%";
        ...
        var d = {}, e = 60,
            ...
            h = a.core.dom.getSize(document.body),
            i = [],
            j = "conf.channel.fixed",
            k = {
                getFixBox: function(b) {
                    var c = a.core.dom.dir(b, {
                        dir: "parent",
                        expr: '[fixed-box="true"]'
                    });
                    return c[0]
                ...
                inFixedOrNoDisplay: function(b) {
                    do
                        if (b && b.style && (a.getStyle(b, "position") === "fixed" || a.getStyle(b, "display") === "none")) return !0; while (b = b.parentNode);
                    return !1
                },
                removePx: function(a) {
                ...
                getSize: function(b) {
                    ...
                    c.width = c.width - k.removePx(a.getStyle(b, "borderLeftWidth")) - k.removePx(a.getStyle(b, "borderRightWidth")) - k.removePx(a.getStyle(b, "paddingLeft")) - k.removePx(a.getStyle(b, "paddingRight"));
                    return c
                },
                ...
                initChannel: function(b) {
                    if ( !! b && !! a.isNode(b)) {
                        var c = k.getUniqueChannel();
                        b.setAttribute("fixed-id", c);
                        a.listener.fire(j, "init", {
                            "fixed-id": c
                        })
                    }
                },
                fireChannel: function(b, c, d) {
                    if ( !! b && !! a.isNode(b)) {
                        ...
                        d = d || {};
                        d["fixed-id"] = e;
                        a.listener.fire(j, c, d)
                    }
                },
                removeChannel: function(a) {
                    k.fireChannel(a, "removefixed");
                    k.fireChannel(a, "destroy");
                ...
                a.addEvent(window, "scroll", g.awake);
                return g
            }(),
            q, u;
        FM.onplJsReady(function() {
            u && clearTimeout(u) && (u = null);
    ...
    var a = document,
        ...
        g = {
            getBy: function(a, b, c) {
                ...
                for (var f = 0, g = e.length; f < g; ++f) a(e[f]) && (d[d.length] = e[f]);
                return d
            },
            ...
            on: function(a, b, c) {
                if (this._isCollection(a))
                    for (var d = 0, e = a.length; d < e; ++d) this._addEvent(a[d], b, c);
                else this._addEvent(a, b, c)
            },
            removeEvent: function(a, b, c) {
                if (this._isCollection(a))
                    for (var d = 0, e = a.length; d < e; ++d) this._removeEvent(a[d], b, c);
                else this._removeEvent(a, b, c)
            },
            getEvent: function() {
            ...
            jsonToQuery: function(a, b) {
                ...
                if (typeof a == "object")
                    for (var e in a)
                        if (a[e] instanceof Array)
                            for (var f = 0, g = a[e].length; f < g; f++) d.push(e + "=" + c(a[e][f], b));
                        else typeof a[e] != "function" && d.push(e + "=" + c(a[e], b));
                return d.length ? d.join("&") : ""
            },
            ...
            storage: function() {
                ...
                if (a) return {
                    ...
                    getAll: function() {
                        var b = a.length,
                            c = null,
                            d = [];
                        for (var e = 0; e < b; e++) c = a.key(e), d.push(c + "=" + this.getKey(c));
                        return d.join("; ")
                    }
                };
                if (window.ActiveXObject) {
                ...
                return {
                    ...
                    set: function(a, b, c) {
                        if (!c || typeof c !== date) c = new Date, c.setDate(c.getDate() + 1);
                        document.cookie = a + "=" + escape(b) + "; expires=" + c.toGMTString()
                    },
                    del: function(a) {
                        document.cookie = a + "=''; expires=Fri, 31 Dec 1999 23:59:59 GMT;"
        ...
        n = {
            ...
            show: function(b, d) {
                if (!b.height) throw "layer height is null";
                if (!b.width) throw "layer width is null";
                if (!b.src) throw "iframe src is null";
                if (!k) {
                    k = a.createElement("div");
                    k.style.cssText = "position:absolute;padding:4px;-moz-border-radius:4px;-webkit-border-radius:4px;background:url(http://img.t.sinajs.cn/t4/style/images/common/layer_bg.png?id=1316690783305) repeat;_background:transparent;";
    ...
    var s = {}, t = {
        ...
        v = {
            get: function(a, b) {
                r = !0;
                var c = {};
                for (var d in a)!t[d] && (c[d] = decodeURIComponent(a[d]));
                var e = 0;
            ...
            x || (x = function(b) {
                ...
                if (e.type) {
                    var f = e.type.split("|"),
                        g = j.hash("click");
                    try {
                        for (var k = 0, l = f.length; k < l; k++) g[f[k]] && g[f[k]](d.el, e)
                    } catch (b) {}
                }
            });
            ...
            for (var c = 0, d = b.length; c < d; c++) j.add(b[c], "click", w.click[b[c]]);
            h.on(a, "click", x);
            g.getBy(function(b) {
            ...
            start: function(a, b) {
                var d = function(c) {
                    ...
                    if (d.id) {
                        if (a)
                            if (c.firstChild) {
                                if (c.firstChild.getAttribute && c.firstChild.getAttribute("pbc-refresh") !== "true") return;
                                var e = {};
                                b = b || {};
                                e.rt = b.rt || "1";
...
STK.register("namespace", function(a) {
    ...
    function g(a, c) {
        var d;
        for (var g = 0; g < a.length; ++g)(d = f(a[g], b)) && e(a[g], d, c)
    }
