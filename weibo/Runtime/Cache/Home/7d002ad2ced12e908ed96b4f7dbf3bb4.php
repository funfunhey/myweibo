...
<div class="pop_usercard f12">
    ...
    <span class="arrow_bor1">
        <i class="sbg2_br"></i>
                        ...
                        <li class="bgw">
                            <span class="somespan bgw">
                               <a  href="<?php echo U('News/newscomment_mine');?>" class="atblog">发出的评论</a>
                               <a href="" class="f">c</a>
                            </span>
    ...
    <?php if(is_array($contentinput)): foreach($contentinput as $key=>$vo): $var = 'notmine'; ?>
<div class="fixbottom" />
    <div class="content-detail bgw">
        ...
        <div class="WB_detail">
            <div class="WB_info">
            <?php if(($var) == "mine"): ?><a href=""style="color:#333;font-size:14px;"><?php echo ($username); ?></a>
                <a href="" class=""><i></i></a>
...
<div class="superpage">
    <div class="page f12">
        <?php if(($pages > 1) AND ($pages <= 10)): ?><a href="/weibo/index.php/Home/News/newscomment/page/<?php echo ($page_pre); ?>"class="page_pre">上一页</a><?php endif; ?>
                <span class="list">
                    <div class="pagelist boxstyle">
                        <ul>
                        <?php $__FOR_START_32686__=$page;$__FOR_END_32686__=0;for($i=$__FOR_START_32686__;$i > $__FOR_END_32686__;$i+=-1){ if(empty($_GET['id'])): ?><li><a href="/weibo/index.php/Home/News/newscomment/page/<?php echo ($i); ?>">第<?php echo ($i); ?>页</a></li>
                            <?php else: ?>
        ...
        <?php if(($pages >= 1) AND ($pages < $page)): ?><a href="/weibo/index.php/Home/News/newscomment/page/<?php echo ($page_next); ?>"class="page_next">下一页</a><?php endif; ?>
