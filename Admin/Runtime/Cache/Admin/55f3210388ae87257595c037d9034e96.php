...
<frameset rows="80px,*" border="0">
    <frame src="<?php echo U('index/top');?>" noresize="true" scrolling="no" style="border-bottom:2px solid #ccc"/>
    <frameset cols="150px,*" border="0">
        <frame src="<?php echo U('index/sidebar',array('action'=>'index'));?>" name="sidebar" noresize="true" scrolling="no" />
