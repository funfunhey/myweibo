...
<script type="text/javascript" src="__PUBLIC__/Js/admin/jquery.easyui.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/Js/admin/locale/easyui-lang-zh_CN.js" ></script>
<script type="text/javascript" src="__PUBLIC__/Js/admin/main.js"></script>
<link rel="stylesheet" type="text/css" href="__PUBLIC__/Js/admin/themes/default/easyui.css" />
<link rel="stylesheet" type="text/css" href="__PUBLIC__/Js/admin/themes/icon.css" />
</head>
...
<eq name="sidebar" value="houtaiindex">
<div class="map">
    管理首页 &gt;&gt; 后台首页
</div>
<table cellspacing="0" class="htindex">
    <tr><th><strong>{$Think.cookie.username}，欢迎开始微博管理</strong></th></tr>
    <tr><td></td></tr>
</table>
</eq>

<eq name="sidebar" value="manager">
<div class="map">
    管理首页 &gt;&gt; 管理员管理
</div>
...
<eq name="sidebar" value="commment">
<div class="map">
    内容管理 &gt;&gt; 所有评论
</div>
<table cellspacing="0">
...
<eq name="sidebar" value="levelcontrol">
<div class="map">
    会员管理 &gt;&gt; 等级管理
</div>
<table cellspacing="0">
